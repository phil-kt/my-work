...
class Rendezvous extends Component {
  ...
  render() {
    ...
    return (
      <ProjectPage
        title="Rendezvous"
        description="An iOS app to help you find your friends in crowded places or, if left in the background, to encourage spontaneous meetings with your friends"
        customLinks={[
